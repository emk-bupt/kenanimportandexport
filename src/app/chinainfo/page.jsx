...
تأكد دائمًا من توثيق كل الدفعيات والمراسلات لتجنب أي سوء تفاهم. طرق الدفع تختلف حسب حجم الطلب ونوع البضاعة والمورد، لذا استفسر دائمًا قبل توقيع أي عقد.`,
    ...
    {
      id: 4,
      title: "التزامات المستورد في مدينة إيوو",
      short:
        "الشراء من سوق إيوو (Yiwu) يختلف عن الشراء المباشر من المصنع. في ييوو...",
      full: `الشراء من سوق إيوو (Yiwu) يختلف عن الشراء المباشر من المصنع. في ييوو:

- أنت مسؤول عن الفحص الشخصي للبضاعة قبل الدفع، لأن المنتجات قد تحتوي على عيوب أو اختلافات.  
- يجب متابعة الإنتاج والشحن بنفسك أو عبر وسيط موثوق.  
- التخليص الجمركي والتنسيق مع شركات الشحن يقع على عاتقك.

أما عند التعامل مع المصنع، الالتزامات أقل، حيث غالبًا يكون لديهم القدرة على التعامل مع الشحن والتخليص، لكن تحتاج لمهارات تفاوض قوية لضمان الجودة والأسعار.

وجود وسيط موثوق في الصين يقلل المخاطر ويوفر لك الوقت، خصوصًا إذا كنت مبتدئًا في استيراد البضائع.`,
    },
    {
      id: 5,
