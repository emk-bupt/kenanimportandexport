...
const ProductsPage = () => {
  ...
  const productsWeWorkWith = [
    {
      title: "خطوط إنتاج ومعدات صناعية",
      description: "معدات صناعية متطورة وخطوط إنتاج كاملة",
      items: ["آلات التصنيع", "معدات المطابع", "خطوط التعبئة", "معدات المطاعم", "آلات النسيج", "معدات الورش"],
    ...
    },
    {
      ...
      items: ["الأجهزة المنزلية", "أدوات القياس", "معدات الإضاءة", "أجهزة الأمان"],
      note: "وفق شروط كل دولة",
    ...
    },
    {
      ...
      items: ["حقائب يد", "حقائب سفر", "محافظ", "أحزمة", "نظارات", "ساعات"],
    ...
    {
      title: "مواد خام وتغليف",
      description: "مواد خام متنوعة ومواد التغليف",
      items: ["أقمشة", "بلاستيك", "ورق", "مواد التغليف", "أدوات يدوية", "مواد البناء"],
          ...
          {activeTab === "workWith" ? (
            <>
              <p className="text-lg md:text-2xl text-white/90 text-center mb-12 font-semibold">
                نقدم خدمات الاستيراد لمجموعة واسعة من المنتجات عالية الجودة من الصين
              </p>
